 ...
 * @author 41525388
 */
public class ListarTitularContaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        TitularContaDaoRelacional dao = null;
        try {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Listar Titular Contas</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Listar todos os titulares e suas contas</h1>");
            if (conexaoEstabelecida) {
                ...
                try {
                    ...
                    out.println("<tr>");
                    out.println("<th>Número Conta</th><th>Titular Conta</th>");
                    out.println("</tr>");
                    for(TitularConta c: titularContas){
                        out.println("<tr>");
                        out.println("<td>" + c.getNroConta() + "</td>");
                        out.println("<td>" + c.getNroTitular() + "</td>");
                        out.println("</tr>");
                    }
                    out.println("</table>");
                } catch (BancoDaoException ex) {
